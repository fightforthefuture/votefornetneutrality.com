<template>
  <div>
    ...
    <p>
      If you submit information to the HelloVote Providers through the HelloVote Tool, you hereby grant the HelloVote Providers a license to use the information as set forth in the <nuxt-link to="/privacy">HelloVote Privacy Policy</nuxt-link>.
    </p>
